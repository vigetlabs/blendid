...
},{"underscore":"YqxD5C"}],"YqxD5C":[function(require,module,exports){
//     Underscore.js 1.6.0
...
module.exports = Backbone.View.extend({
  ...
  render: function() {
    this.$el.html(this.template({
      ...
      tools: ['Browserify', 'Image optimization', 'Browserify-shim', 'CoffeeScript', 'Compass', 'Handlebars', 'Non common-js jquery plugin', 'Npm backbone', 'Npm jquery', 'SASS', 'Underscore (included with Backbone)']
    }));
    return plugin();
  }
});
